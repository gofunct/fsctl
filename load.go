...
func (f *Fs) GetDir(src, dst string) {
	var moder = getter.ClientModeDir
...
func (f *Fs) GetFile(src, dst string) {
	var moder = getter.ClientModeFile
...
func (f *Fs) LoadConfig(src string) {
	var moder = getter.ClientModeFile
